...
public class TrainerDialogCreator {
    ...
    public Dialog getMealDialog(List<Meal> meals, MealDto mealDto, Button exerciseButton) {
    ...
    public Dialog getExerciseDialog(List<Exercise> exercises, ExerciseDto exerciseDto, Button finishButton) {
        Dialog dialog = new Dialog();
        VerticalLayout dialogLayout = new VerticalLayout();
        dialogLayout.setAlignItems(FlexComponent.Alignment.CENTER);
        dialogLayout.setJustifyContentMode(FlexComponent.JustifyContentMode.CENTER);
